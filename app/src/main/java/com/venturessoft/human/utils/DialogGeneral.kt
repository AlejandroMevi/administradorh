...
import com.venturessoft.human.databinding.GenericDialogBinding
...
class DialogGeneral(
    ...
    override fun onCreateView(
        ...
        binding = GenericDialogBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.dialogTitle.text = if (!title.isNullOrEmpty()) title else getString(R.string.errormissing)
