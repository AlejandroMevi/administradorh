...
class ConsultaCompaniaDataRepository: ValidateAndRefreshJWTRepository() {
    ...
    fun getConsultaCompaniaData(consultaCompaniaRequest: ConsultaCompaniaRequest, responseLiveData: MutableLiveData<ConsultaCompaniaResponse>, isLoading: MutableLiveData<Boolean>, codeError: MutableLiveData<Int>) {
        ...
        validateAndRefreshJWT(callBackJWTValidateAndRefresh = object : CallBackJWTValidateAndRefresh {
            override fun onSuccess() {
                ...
                retrofitClient.getConsultaCompañiaData(User.token, User.scia!![0].cia, User.idUsuario).enqueue(

                    object : Callback<ConsultaCompaniaResponse> {
                        ...
                        override fun onResponse(call: Call<ConsultaCompaniaResponse>?, response: Response<ConsultaCompaniaResponse>?) {
                            if (response!!.isSuccessful) {
                                ...
                                getConsultaCompaniaData(consultaCompaniaRequest, responseLiveData, isLoading, codeError)
                            } else {
