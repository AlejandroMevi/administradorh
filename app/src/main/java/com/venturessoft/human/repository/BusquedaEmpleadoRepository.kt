...
class BusquedaEmpleadoRepository : ValidateAndRefreshJWTRepository() {
    ...
    fun getBusquedaEmpleado(busquedaEmpleadoRequest: BusquedaEmpleadoRequest, responseLiveData: MutableLiveData<BusquedaEmpleadoResponse>, isLoading: MutableLiveData<Boolean>, codeError: MutableLiveData<Int>) {
        isLoading.postValue(true)
        validateAndRefreshJWT(callBackJWTValidateAndRefresh = object : CallBackJWTValidateAndRefresh {

            override fun onSuccess() {

                retrofitClient.getBusquedaEmpleado(busquedaEmpleadoRequest, User.token).enqueue(

                    object : Callback<BusquedaEmpleadoResponse> {
                        ...
                        override fun onResponse(call: Call<BusquedaEmpleadoResponse>?, response: Response<BusquedaEmpleadoResponse>?) {
                            if (response!!.isSuccessful) {
                                ...
                                getBusquedaEmpleado(busquedaEmpleadoRequest, responseLiveData, isLoading, codeError)
                            }
                            else {
