...
class FilterReportFragmentViewModel {
    var reporteChecadasResponseMutableData = MutableLiveData<ReporteChecadasResponse>()
    var reporteChecadasFromResponseMutableData = MutableLiveData<ReporteChecadasResponse>()
    ...
    fun getReporteChecadaDateFromService(reporteChecadasRequest: ReporteChecadasRequest) {
        isLoading.postValue(true)
        ReporteChecadasRepository().getReporteChecadas(reporteChecadasRequest, reporteChecadasFromResponseMutableData, isLoading,codeError)
    }
