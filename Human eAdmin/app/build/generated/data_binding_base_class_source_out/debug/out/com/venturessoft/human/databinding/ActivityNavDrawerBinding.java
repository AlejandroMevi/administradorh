...
public final class ActivityNavDrawerBinding implements ViewBinding {
  ...
  @NonNull
  public final AppBarNavDrawerBinding toolbarNav;
  ...
  private ActivityNavDrawerBinding(@NonNull DrawerLayout rootView,
      ...
      @NonNull AppBarNavDrawerBinding toolbarNav) {
    this.rootView = rootView;
    this.drawerLayout = drawerLayout;
    this.navView = navView;
    this.toolbarNav = toolbarNav;
  }
  ...
  public static ActivityNavDrawerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.toolbarNav;
      View toolbarNav = ViewBindings.findChildViewById(rootView, id);
      if (toolbarNav == null) {
        break missingId;
      }
      AppBarNavDrawerBinding binding_toolbarNav = AppBarNavDrawerBinding.bind(toolbarNav);

      return new ActivityNavDrawerBinding((DrawerLayout) rootView, drawerLayout, navView,
          binding_toolbarNav);
    }
